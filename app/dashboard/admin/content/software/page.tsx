    ...
    return (
        <div className="space-y-8 pb-10">
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                <div>
                    <h2 className="text-2xl sm:text-3xl font-bold tracking-tight">সফটওয়্যার লাইব্রেরি ম্যানেজমেন্ট</h2>
                    <p className="text-xs sm:text-sm text-muted-foreground font-medium">সিস্টেমের সকল সফটওয়্যার, মিরর লিঙ্ক এবং ভার্সন কন্ট্রোল করুন</p>
                </div>
